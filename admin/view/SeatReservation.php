...
<h1>SeatReservations for flight <?php echo $FlightID ?> </h1>
...
<div class="row">
    ...
    <div class="col-md-12" >
        <h2>Add a new Seatreservation for flight <?php echo $FlightID ?> </h2>
        <div class="row">
            <div class="col-sm-6" style="width: 100%;">
                <form action="?page=addCustomer" method="post">
                    <div class="form-group">
                        ...
                        <select name="givenGender" class="form-control" id="sel1" required>
                        ...
                        <select name="givenCountry" class="form-control" id="sel1" required>
